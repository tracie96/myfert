  ...
  return (
    <div className="bg-gradient-white">
                      ...
                      <div className="text-center">
                        <div className="row justify-content-center">
                          <div className="col-lg-10">
                            <h1 className="h4 mb-4" style={{ color: '#01ACEE', fontWeight: 700 }}>
                        ...
                        <div className="row text-center image-row">
                          ...
                          >
                            <div
                              className="card clickable-card" style={{backgroundColor: isClinicianHovered ? '#CEF2F4':''}}
                              onClick={() => setRole(1)}
                            >
                          ...
                          >
                            <div
                              className="card clickable-card" style={{backgroundColor: isPatientHovered ? '#EFD0BD':''}}
                              onClick={() => setRole(2)}
                            >
                              <div className="card-body image-container">
      ...
      {userRole && (
          <div className="row justify-content-center">
            <div className="col-lg-12">
              {userRole === "1" && <DoctorSignup userRole={userRole} />}
              {userRole === "2" && <PatientSignup userRole={userRole} />}
            </div>
        </div>
      )}
    </div>
